...
def update_grid(new_player_index: int, n: int) -> List:
    ...
    print(
        f"\nYou are currently located in room: {cordinations[new_player_index]}")
    limitations = []
    if cordinations[new_player_index][0] == 1:
        limitations.append('UP')
        if cordinations[new_player_index][0] == 1 and cordinations[new_player_index][1] == 1:
            limitations.append('LEFT')
        elif cordinations[new_player_index][0] == 1 and cordinations[new_player_index][1] == n:
            limitations.append('RIGHT')
    elif cordinations[new_player_index][0] == n:
        limitations.append('DOWN')
        if cordinations[new_player_index][0] == n and cordinations[new_player_index][1] == 1:
            limitations.append('LEFT')
        elif cordinations[new_player_index][0] == n and cordinations[new_player_index][1] == n:
            limitations.append('RIGHT')
    elif cordinations[new_player_index][1] == 1:
        limitations.append('LEFT')
        if cordinations[new_player_index][1] == 1 and cordinations[new_player_index][0] == 1:
            limitations.append('UP')
        elif cordinations[new_player_index][1] == 1 and cordinations[new_player_index][0] == n:
            limitations.append('DOWN')
    elif cordinations[new_player_index][1] == n:
        limitations.append('RIGHT')
        if cordinations[new_player_index][1] == n and cordinations[new_player_index][0] == 1:
            limitations.append('UP')
        elif cordinations[new_player_index][1] == n and cordinations[new_player_index][0] == n:
            limitations.append('DOWN')
    else:
